...
for shock in [0.1, 0.15, 0.2]:
    ...
    env.reset()
    local_critic, update_critic = Centralized_Critic(6, 2, 0, num_agents=5), Centralized_Critic(6, 2, 0, num_agents=5)
    ...
    for idx, name in enumerate(bank_names):
        agent = CA2C_Agent(6, 2, num_agents=5, random_seed=0, name=name, critic_local=local_critic, critic_target=update_critic)
